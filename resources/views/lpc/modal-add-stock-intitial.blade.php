<div class="modal" tabindex="-1" id="modal-add-stock-initial">
    <div class="modal-dialog ">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Ajouter stock initial </h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="btn-close"></button>
        </div>
        <form class="cmxform" id="formAddStockInitial" enctype="multipart/form-data">
            @csrf
