                ...
                <div class="card-body print-section" id="printable">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                        ...
                        <div>
                            ...
                            <p> Nom : <b>{{$breeder->name}}</b>  | Date : du <b>{{$datedebut}}</b>  au <b>{{$datefin}}</b>  </p><br>
                        ...
                        <tbody>
                            ...
                            @foreach ($lineachats as $lineachat)
                                <tr>
                                    ...
                                    <td>{{$lineachat->created_at->format('d-m-y')}}</td>
                                    <td>{{$lineachat->qte}}</td>
                                    <td>{{$lineachat->price}}</td>
                                    <td>{{$lineachat->total}}</td>
                                </tr>

                                @php
                                    $global = $global + $lineachat->total ;
