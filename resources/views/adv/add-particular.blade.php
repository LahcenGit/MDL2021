...
<div class="page-content">
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Ajouter un particulier</li>
        </ol>
    </nav>
        ...
        <div class="col-md-8 grid-margin">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="{{url('adv/particulars')}}" enctype="multipart/form-data">
                        @csrf
                            <div class="row mb-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control mb-4 mb-md-0  input-default " name="phone"  value="{{old('phone')}}" placeholder="phone"  />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control mb-4 mb-md-0  input-default " name="address"  value="{{old('address')}}" placeholder="adresse" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-md-6">
