                ...
                <div class="card-body print-section" id="printable">
                    ...
                    <div class="d-flex justify-content-between" >
                        ...
                        <div class="infos-client" style="width: 350px;">
                            ...
                            <p ><b> Nom :</b> {{$order->professional->user->name}}<br>
                            <b> Tél: </b> {{$order->professional->phone}}  <br>
                            <b> Adresse:</b> {{$order->professional->address}} <br>
                             <b> Wilaya:</b>  {{ucfirst($order->professional->wilaya)}}<br>
