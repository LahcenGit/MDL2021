            ...
            <div class="col-md-4 mt-2" style="background-color: #EFEFEF ; padding: 30px;">
                <div class="mb-4">
                    ...
                    <label class="title-pack">Pack "{{$pack}}"</label>
                        ...
                        <span>- 3 x Boules Mozzarella</span> <br>
                        <span>- 1 Tot bag</span> <br>
                    @endif
...
$('.productadd').on('change', function(){
    if($(this).val() == "feta500" ){
        ...
        $('#sub-total').html('2590');
        $('#total').html(parseInt($('#delivery').html())+2000 + 590);

        $('#inp-added').val("500g Feta");
        $('#inp-total').val(  parseInt($('#delivery').html())+2000 + 590);
        $('#total').html(parseInt($('#delivery').html())+2000 + 590);
        $('#total').html(parseInt($('#delivery').html())+2000 + 590);
    }
    ...
    if($(this).val() == "basilic" ){
        ...
        $('#inp-total').val(  parseInt($('#delivery').html())+2000 + 450);

        $('#total').html(parseInt($('#delivery').html())+2000 + 450);
    ...
    if($(this).val() == "boule" ){
        ...
        $('#inp-total').val(  parseInt($('#delivery').html())+2000 + 160);

        $('#total').html(parseInt($('#delivery').html())+2000 + 160);
    }
