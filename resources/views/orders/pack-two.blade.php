...
<div class="card">
<div class="card-body">
<h4 class="text-center mb-3 mt-4"> <span style="color: #6FB53E">Etape 2/3 : </span> Personnaliser votre pack <span style="color: #6FB53E">9ouffa</span>  </h4>
    ...
    <div class="container" style="margin-top: 50px;">  
        ...
        <div class="row mt-3">
            ...
            <div class="col-md-6" >
                ...
                <label class="form-label" style="background-color: #E2E2E2; padding:20px;">1 Cuffin</label>
            </div>

        </div>

        <input type="hidden" value="pack2" name="pack">
